...
<CardGroup cols={2}>
  <Card title="Site Management" icon="gear" href="/api/scraping/sites">
  ...
  <Card title="Version Tracking" icon="clock-rotate-left" href="/api/properties/versions">
    Track property changes over time.
  </Card>
  <Card title="Quality Scoring" icon="star" href="/development/database">
